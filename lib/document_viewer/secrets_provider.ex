defmodule DocumentViewer.SecretsProvider do
  @moduledoc """
  ...
  defp load_prefix(config, prefix, opts) when is_binary(prefix) do
    ...
    |> update_config(
      ...
      fn key ->
        [
          document_viewer: [
            {DocumentViewerWeb.Endpoint, [secret_key_base: key]}
          ]
        ]
      end,
      opts
    ...
    |> update_config(
      prefix <> "-guardian-secret-key",
      fn key ->
        [
          document_viewer: [
            {DocumentViewerWeb.AuthManager, [secret_key: key]}
          ]
        ]
      end,
      opts
